...
public class AgregarCliente extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setMinimumSize(new java.awt.Dimension(393, 458));
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/agregar.png"))); // NOI18N
    ...
    private void jbGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbGuardarActionPerformed
        ...
        long documento=Integer.parseInt(jtDni.getText());
       ...
       Cliente c=new Cliente(documento,nombre,apellido,ciudad,domicilio);
        
       
      
        Directorio directorio= Menu.getDirectorio();
        if(directorio.agregarCliente(telefono, c)){
